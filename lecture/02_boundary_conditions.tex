...
\chapter[Boundary conditions and interfaces]{{\bfseries Boundary} conditions and {\bfseries interfaces}}
...
\end{equation}
so that finally:
\footnote{This result could have been obtained directly by application of the \textbf{surface divergence theorem}\index{divergence!surface} which can be stated as:
\begin{equation}
